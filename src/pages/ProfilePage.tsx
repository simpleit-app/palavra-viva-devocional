            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-muted/40 p-4 rounded-lg">
                  ...
                  <p className="text-3xl font-bold">{currentUser?.chaptersRead || 0}</p>
                </div>
                <div className="bg-muted/40 p-4 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-1">Reflexões</p>
                  <p className="text-3xl font-bold">{currentUser?.totalReflections || 0}</p>
                </div>
                <div className="bg-muted/40 p-4 rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mt-4">
                Membro desde: {currentUser?.createdAt ? new Date(currentUser.createdAt).toLocaleDateString('pt-BR') : '-'}
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="flex justify-between items-center">
                ...
                {currentUser?.subscriptionTier === 'pro' ? (
                  <span className="bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 text-xs px-2.5 py-1 rounded-full font-medium">
                    Ativo
                  </span>
                ) : (
                  <span className="bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300 text-xs px-2.5 py-1 rounded-full font-medium">
                    Limitado
                  </span>
                )}
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">Acesso limitado</p>
